...
//
    ...
    )
    {
        auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener{
            ...
            {
                _firebaseUser.postValue(auth.currentUser)
                saveImage(name, username, bio, email, password, imageUri, auth.currentUser?.uid, context)
            }
            else{
    ...
    private fun saveImage(name: String, username: String, bio: String, email: String, password: String, imageUri: Uri, uid: String?, context: Context) {
...
//
        ...
        val userData = UserModel(name, username, bio, email, password, toString, uid!!)
